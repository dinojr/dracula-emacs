...
(let ((colors '((fg1          "#f8f8f2")      ; Assigment form: VARIABLE COLOR [TTY-COLOR]
      ...
      (faces '(;; default
	       ...
	       (org-beamer-tag :bold nil :inherit foreground :height .8)
               ...
               (org-level-1 :inherit bold :foreground ,rainbow-4 :height 1.1)
               ...
               (org-tag :foreground ,rainbow-4 :bold t :inherit background)
	       (org-inlinetask :inherit foreground :bold nil)
               (org-todo :foreground ,rainbow-5 :bold t :background ,bg2)
               (org-upcoming-deadline :foreground ,rainbow-7)
               (org-warning :underline nil :foreground ,builtin)
               ;; outline
